...
public class MsgTextAreaJPopupMenuBeanInfo extends SimpleBeanInfo {
	...
	private static PropertyDescriptor[] getPdescriptor() {
		...
		try {
			properties[PROPERTY_accessibleContext] = new PropertyDescriptor("accessibleContext", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getAccessibleContext", null); // NOI18N
			properties[PROPERTY_actionMap] = new PropertyDescriptor("actionMap", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getActionMap",
					"setActionMap"); // NOI18N
			properties[PROPERTY_alignmentX] = new PropertyDescriptor("alignmentX", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getAlignmentX",
					"setAlignmentX"); // NOI18N
			properties[PROPERTY_alignmentY] = new PropertyDescriptor("alignmentY", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getAlignmentY",
					"setAlignmentY"); // NOI18N
			properties[PROPERTY_ancestorListeners] = new PropertyDescriptor("ancestorListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getAncestorListeners", null); // NOI18N
			properties[PROPERTY_autoscrolls] = new PropertyDescriptor("autoscrolls", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getAutoscrolls",
					"setAutoscrolls"); // NOI18N
			properties[PROPERTY_background] = new PropertyDescriptor("background", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getBackground",
					"setBackground"); // NOI18N
			properties[PROPERTY_backgroundSet] = new PropertyDescriptor("backgroundSet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isBackgroundSet",
					null); // NOI18N
			properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor("baselineResizeBehavior", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_borderPainted] = new PropertyDescriptor("borderPainted", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isBorderPainted",
					"setBorderPainted"); // NOI18N
			...
			properties[PROPERTY_componentAtIndex] = new IndexedPropertyDescriptor("componentAtIndex", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, null,
					null, "getComponentAtIndex", null); // NOI18N
			properties[PROPERTY_componentCount] = new PropertyDescriptor("componentCount", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getComponentCount",
					null); // NOI18N
			properties[PROPERTY_componentListeners] = new PropertyDescriptor("componentListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getComponentListeners", null); // NOI18N
			properties[PROPERTY_componentOrientation] = new PropertyDescriptor("componentOrientation", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getComponentOrientation", "setComponentOrientation"); // NOI18N
			properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor("componentPopupMenu", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_containerListeners] = new PropertyDescriptor("containerListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor("debugGraphicsOptions", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_doubleBuffered] = new PropertyDescriptor("doubleBuffered", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isDoubleBuffered",
					"setDoubleBuffered"); // NOI18N
			properties[PROPERTY_dropTarget] = new PropertyDescriptor("dropTarget", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getDropTarget",
			...
			properties[PROPERTY_focusable] = new PropertyDescriptor("focusable", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isFocusable",
					"setFocusable"); // NOI18N
			properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor("focusCycleRoot", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isFocusCycleRoot",
					"setFocusCycleRoot"); // NOI18N
			properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor("focusCycleRootAncestor", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getFocusCycleRootAncestor", null); // NOI18N
			properties[PROPERTY_focusListeners] = new PropertyDescriptor("focusListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getFocusListeners",
					null); // NOI18N
			...
			properties[PROPERTY_focusTraversable] = new PropertyDescriptor("focusTraversable", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"isFocusTraversable", null); // NOI18N
			properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor("focusTraversalKeys", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, null,
					null, null, "setFocusTraversalKeys"); // NOI18N
			properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor("focusTraversalKeysEnabled",
					org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled"); // NOI18N
			properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor("focusTraversalPolicy", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor("focusTraversalPolicyProvider",
					org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider"); // NOI18N
			properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor("focusTraversalPolicySet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_foreground] = new PropertyDescriptor("foreground", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getForeground",
					"setForeground"); // NOI18N
			properties[PROPERTY_foregroundSet] = new PropertyDescriptor("foregroundSet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isForegroundSet",
					null); // NOI18N
			...
			properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor("graphicsConfiguration", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor("hierarchyBoundsListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getHierarchyBoundsListeners", null); // NOI18N
			properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor("hierarchyListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getHierarchyListeners", null); // NOI18N
			properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor("ignoreRepaint", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getIgnoreRepaint",
					"setIgnoreRepaint"); // NOI18N
			properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor("inheritsPopupMenu", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getInheritsPopupMenu", "setInheritsPopupMenu"); // NOI18N
			properties[PROPERTY_inputContext] = new PropertyDescriptor("inputContext", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getInputContext",
					null); // NOI18N
			...
			properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor("inputMethodListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getInputMethodListeners", null); // NOI18N
			properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor("inputMethodRequests", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getInputMethodRequests", null); // NOI18N
			properties[PROPERTY_inputVerifier] = new PropertyDescriptor("inputVerifier", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getInputVerifier",
			...
			properties[PROPERTY_keyListeners] = new PropertyDescriptor("keyListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getKeyListeners",
					null); // NOI18N
			...
			properties[PROPERTY_lightWeightPopupEnabled] = new PropertyDescriptor("lightWeightPopupEnabled", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"isLightWeightPopupEnabled", "setLightWeightPopupEnabled"); // NOI18N
			...
			properties[PROPERTY_locationOnScreen] = new PropertyDescriptor("locationOnScreen", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getLocationOnScreen", null); // NOI18N
			properties[PROPERTY_managingFocus] = new PropertyDescriptor("managingFocus", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isManagingFocus",
					null); // NOI18N
			...
			properties[PROPERTY_maximumSize] = new PropertyDescriptor("maximumSize", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getMaximumSize",
					"setMaximumSize"); // NOI18N
			properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor("maximumSizeSet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isMaximumSizeSet",
					null); // NOI18N
			properties[PROPERTY_menuKeyListeners] = new PropertyDescriptor("menuKeyListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getMenuKeyListeners", null); // NOI18N
			properties[PROPERTY_minimumSize] = new PropertyDescriptor("minimumSize", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getMinimumSize",
					"setMinimumSize"); // NOI18N
			properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor("minimumSizeSet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "isMinimumSizeSet",
					null); // NOI18N
			properties[PROPERTY_mouseListeners] = new PropertyDescriptor("mouseListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getMouseListeners",
					null); // NOI18N
			properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor("mouseMotionListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getMouseMotionListeners", null); // NOI18N
			properties[PROPERTY_mousePosition] = new PropertyDescriptor("mousePosition", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getMousePosition",
					null); // NOI18N
			properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor("mouseWheelListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor("nextFocusableComponent", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor("optimizedDrawingEnabled", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"isOptimizedDrawingEnabled", null); // NOI18N
			properties[PROPERTY_paintingForPrint] = new PropertyDescriptor("paintingForPrint", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"isPaintingForPrint", null); // NOI18N
			...
			properties[PROPERTY_popupMenuListeners] = new PropertyDescriptor("popupMenuListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getPopupMenuListeners", null); // NOI18N
			...
			properties[PROPERTY_preferredSize] = new PropertyDescriptor("preferredSize", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getPreferredSize",
					"setPreferredSize"); // NOI18N
			properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor("preferredSizeSet", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"isPreferredSizeSet", null); // NOI18N
			properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor("propertyChangeListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getPropertyChangeListeners", null); // NOI18N
			properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor("registeredKeyStrokes", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getRegisteredKeyStrokes", null); // NOI18N
			properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor("requestFocusEnabled", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
			...
			properties[PROPERTY_selectionModel] = new PropertyDescriptor("selectionModel", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getSelectionModel",
					"setSelectionModel"); // NOI18N
			...
			properties[PROPERTY_toolTipText] = new PropertyDescriptor("toolTipText", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getToolTipText",
					"setToolTipText"); // NOI18N
			properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor("topLevelAncestor", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getTopLevelAncestor", null); // NOI18N
			properties[PROPERTY_transferHandler] = new PropertyDescriptor("transferHandler", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
					"getTransferHandler", "setTransferHandler"); // NOI18N
			...
			properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor("verifyInputWhenFocusTarget",
					org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget"); // NOI18N
			properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor("vetoableChangeListeners", org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class,
	...
	private static EventSetDescriptor[] getEdescriptor() {
		...
		try {
			eventSets[EVENT_ancestorListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "ancestorListener",
			...
			eventSets[EVENT_componentListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "componentListener",
			...
			eventSets[EVENT_containerListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "containerListener",
			...
			eventSets[EVENT_focusListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "focusListener",
					java.awt.event.FocusListener.class, new String[] { "focusGained", "focusLost" }, "addFocusListener", "removeFocusListener"); // NOI18N
			eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "hierarchyBoundsListener",
			...
			eventSets[EVENT_hierarchyListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "hierarchyListener",
					java.awt.event.HierarchyListener.class, new String[] { "hierarchyChanged" }, "addHierarchyListener", "removeHierarchyListener"); // NOI18N
			eventSets[EVENT_inputMethodListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "inputMethodListener",
			...
			eventSets[EVENT_keyListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "keyListener",
					java.awt.event.KeyListener.class, new String[] { "keyTyped", "keyPressed", "keyReleased" }, "addKeyListener", "removeKeyListener"); // NOI18N
			eventSets[EVENT_menuKeyListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "menuKeyListener",
					javax.swing.event.MenuKeyListener.class, new String[] { "menuKeyTyped", "menuKeyPressed", "menuKeyReleased" }, "addMenuKeyListener", "removeMenuKeyListener"); // NOI18N
			eventSets[EVENT_mouseListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "mouseListener",
					java.awt.event.MouseListener.class, new String[] { "mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited" }, "addMouseListener",
					"removeMouseListener"); // NOI18N
			eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "mouseMotionListener",
			...
			eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "mouseWheelListener",
					java.awt.event.MouseWheelListener.class, new String[] { "mouseWheelMoved" }, "addMouseWheelListener", "removeMouseWheelListener"); // NOI18N
			eventSets[EVENT_popupMenuListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "popupMenuListener",
					javax.swing.event.PopupMenuListener.class, new String[] { "popupMenuWillBecomeVisible", "popupMenuWillBecomeInvisible", "popupMenuCanceled" },
					"addPopupMenuListener", "removePopupMenuListener"); // NOI18N
			eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "propertyChangeListener",
			...
			eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor(org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class, "vetoableChangeListener",
	...
	private static MethodDescriptor[] getMdescriptor() {
		...
		try {
			...
			methods[METHOD_actionPerformed1] = new MethodDescriptor(
					org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class.getMethod("actionPerformed", new Class[] { java.awt.event.ActionEvent.class })); // NOI18N
			...
			methods[METHOD_addPropertyChangeListener12] = new MethodDescriptor(
			...
			methods[METHOD_applyComponentOrientation14] = new MethodDescriptor(
			...
			methods[METHOD_checkImage17] = new MethodDescriptor(
			...
			methods[METHOD_checkImage18] = new MethodDescriptor(
			...
			methods[METHOD_createVolatileImage27] = new MethodDescriptor(
			...
			methods[METHOD_getActionForKeyStroke45] = new MethodDescriptor(
			...
			methods[METHOD_getPropertyChangeListeners63] = new MethodDescriptor(
			...
			methods[METHOD_getToolTipLocation65] = new MethodDescriptor(
			...
			methods[METHOD_imageUpdate72] = new MethodDescriptor(
			...
			methods[METHOD_isLightweightComponent80] = new MethodDescriptor(
			...
			methods[METHOD_main93] = new MethodDescriptor(
					org.tio.examples.im.client.ui.component.MsgTextAreaJPopupMenu.class.getMethod("main", new Class[] { java.lang.String[].class })); // NOI18N
			...
			methods[METHOD_prepareImage112] = new MethodDescriptor(
			...
			methods[METHOD_processKeyEvent117] = new MethodDescriptor(javax.swing.JPopupMenu.class.getMethod("processKeyEvent",
					new Class[] { java.awt.event.KeyEvent.class, javax.swing.MenuElement[].class, javax.swing.MenuSelectionManager.class })); // NOI18N
			methods[METHOD_processKeyEvent117].setDisplayName("");
			methods[METHOD_processMouseEvent118] = new MethodDescriptor(javax.swing.JPopupMenu.class.getMethod("processMouseEvent",
					new Class[] { java.awt.event.MouseEvent.class, javax.swing.MenuElement[].class, javax.swing.MenuSelectionManager.class })); // NOI18N
			methods[METHOD_processMouseEvent118].setDisplayName("");
			methods[METHOD_putClientProperty119] = new MethodDescriptor(
			...
			methods[METHOD_registerKeyboardAction120] = new MethodDescriptor(javax.swing.JComponent.class.getMethod("registerKeyboardAction",
			...
			methods[METHOD_registerKeyboardAction121] = new MethodDescriptor(
			...
			methods[METHOD_removePropertyChangeListener127] = new MethodDescriptor(
			...
			methods[METHOD_repaint131] = new MethodDescriptor(
			...
			methods[METHOD_setComponentZOrder144] = new MethodDescriptor(
			...
			methods[METHOD_setDefaultLightWeightPopupEnabled145] = new MethodDescriptor(
					javax.swing.JPopupMenu.class.getMethod("setDefaultLightWeightPopupEnabled", new Class[] { boolean.class })); // NOI18N
			...
			methods[METHOD_unregisterKeyboardAction156] = new MethodDescriptor(
